	...
	<CFIF IsDefined("FileGenerate")>
		<CFOUTPUT>
			...
			<CFELSE>
				...
				<CFSET	FileName	=	"COLLATARAL.CSV">
				<CFSET	FILE_DATA	=	"">
					
				<CFSET	CPCode 		= 	"CPCode" >
				<CFSET	AccountCode	=	"AccountCode">	
				<CFSET	TraderType	=	"TraderType">
				<CFSET	Deposite	=	"Deposite">
				<CFSET	Cash		=	"Cash">
				<CFSET	FD			=	"FD">

				<CFSET	FILE_DATA	=	"#FILE_DATA##CPCode#,#AccountCode#,#TraderType#,#Deposite#,#Cash#,#FD#"> 
...
<INPUT type="Hidden" name="FinStart" 	value="#FinStart#">
	...
	<TABLE WIDTH="100%" border="0" cellpadding="0" cellspacing="0" class="StyleReportParameterTable1" STYLE="background-color:PINK">
		...
		<TR>
			<TH ALIGN="right" COLSPAN="3" WIDTH="10%">&nbsp;Cash Reqd In Collatral&nbsp;:</TH>
