			...
			<table align="center" cellpadding="0" cellspacing="0" width="50%" class="StyleReportParameterTable1">
				<CFTRY>
					<CFSTOREDPROC procedure="CAPS_CONTRACT_NUMBER_CANCELLATION" datasource="#Client.database#" returncode="Yes">
						...
						<CFPROCPARAM type="In" cfsqltype="CF_SQL_VARCHAR" dbvarname="@ClientId" value="" maxlength="10" null="No">
						<CFPROCPARAM type="In" cfsqltype="CF_SQL_VARCHAR" dbvarname="@USERID" value="#CLIENT.USERNAME#" maxlength="100" null="No">
						<CFPROCPARAM type="In" cfsqltype="CF_SQL_VARCHAR" dbvarname="@IPADD" value="#CGI.REMOTE_ADDR#" maxlength="100" null="No">
					</CFSTOREDPROC>
