	...
	<CFIF isdefined("CmdGenerate")>
		...
		<CFIF Format eq "Old">			
			...
			<cfelseif Format eq "New3">
				...
				<CFINCLUDE TEMPLATE="New3UccWebX.cfm">
				<cfelseif Format eq "New4">
				<cfquery name="getsystemsettingsvalue" datasource="#client.database#">
					select ISNULL(UCCEXPORT_COMPULSORY,'N') UCCEXPORT_COMPULSORY
					FROM SYSTEM_SETTINGS
					WHERE
...
<CFIF IsDefined('CmdView')>		
  ...
  <CFQUERY NAME="GETCLIENTLIST" datasource="#Client.database#" DBTYPE="ODBC">
 		Select DISTINCT client_id,client_name,CLIENT_NATURE,REGISTRATION_DATE,Last_Modified_date ,'Active' ACTIVE_INACTIVE
		...
		<cfelse>
			<cFIF NOT IsDefined("Brokerage")>
				AND CLIENT_ID IN (SELECT CLIENT_ID
									...
									AND CONVERT(DATETIME,CONVERT(VARCHAR(10),UPDATETIME,103),103) BETWEEN CONVERT(DATETIME,'#Reg_date#',103) AND CONVERT(DATETIME,'#Reg_date_TO#',103)
									)	
			</cFIF>					
		</cfif>
...
<cfelse>
  <CFQUERY NAME="GETCLIENTLIST" datasource="#Client.database#" DBTYPE="ODBC">
 		Select DISTINCT a.client_id,client_name,CLIENT_NATURE,REGISTRATION_DATE,Last_Modified_date,active_inactive
	...
	<div align="left" style="position:absolute; overflow:auto; height:89%; top:5%; left:0%;">
	 <TABLE   WIDTH="100%" BORDER="0" ALIGN="center"  CELLPADDING="0" CELLSPACING="1">			
			...
			<TR style="font-size:9px;font:"Trebuchet MS";" NOWRAP  bgcolor="E3F3A3">
				...
				<TD ALIGN="LEFT" NOWRAP width="10%">&nbsp;#active_inactive#</TD>
			</TR>
		 ...
		 <TR bgcolor="##FFFFCC">
			<TH ALIGN="LEFT"  COLSPAN="3" NOWRAP>
					Format:&nbsp;<select name="Format" >
						...
						<option value="New3" selected>New Format From 02 May 2013</option>
						<option value="New4" selected>New Format From 10 Oct 2013</option>
						<option value="AI" >Active/Inactive</option>
					</select>
