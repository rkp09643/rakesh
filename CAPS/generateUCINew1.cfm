...
<CFIF getsystemsettingsvalue.UCCEXPORT_COMPULSORY EQ "Y">
	<CFINCLUDE TEMPLATE="generateUCINewCOMP1.cfm">
	<cfabort>
</CFIF>	
...
<CFQUERY NAME="GetClientDetails" datasource="#Client.database#">
	SELECT DISTINCT  A.CLIENT_ID,A.CLIENT_NAME,B.MARKET MARKET1,A.COMPANY_CODE,A.REGISTRATION_DATE,A.LAST_MODIFIED_DATE,
		...
		ISNULL(PAN_NAME,A.CLIENT_NAME) PAN_NAME,UpdationFlag,RelationShip,MasterPan,TypeOfFacility
...
<CFLOOP QUERY="getClientDetails" > <!---  group="CLIENT_ID" groupcasesensitive="no" --->
	...
	<CFQUERY NAME="GETBANKDETAILS" datasource="#Client.database#">
		...
		order by Default_Ac desc 
				...
				<cfoutput>
					<CFSET FINALSTRING = "#FINALSTRING##SEGMENT#|#CLIENTID#|#CLIENT_NAME1#|#CATEGORY1#|#PAN_NO1#|#EMAILID#|#ADD1#|#ADD2#|#ADD3#|#CITY#|#STATE#|#COUNTRY#|#PINCODE#|#ISDCODE#|#STD_CODE#|#RESI_TEL_NO1#|#MOBILE_NO#">
					...
					<CFIF ERRORCODE LTE 10>
						<CFSET FINALSTRING = "#FINALSTRING##UpdationFlag1#|#RelationShip1#|#MasterPan1#|#TypeOfFacility1#|E">
					<cfelse>
