...
<CFSET Trade_Date = "#txtOrderDate#">
	...
	<CFSET	OnlyFileName	=	"#left(cocd,1)#_#TRIM(getclient.Trade_Date_YearFormat)#_#TRIM(CLIENT_ID)#_#BatchNumber#.iso">

	<CFSET	File_Name	=	"C:\STPFILES\#OnlyFileName#">

	<CFFILE ACTION="write" FILE="#File_Name#" OUTPUT=""ADDNEWLINE="no"> 
	
	<Cfset TotalCon = GetClient.recordcount>   
	<CFLOOP QUERY="GetClient">
			<Cfset CurrentCon = currentrow>   
		...
		<!--- <CFIF	BQTY	GT	0>
			...
			<CFELSE>
				...
				<cFSET PAYINDATE =TRIM(PAYINDATE)>
			...
			<!--- Start Mandatory Block C (Confirmation details) --->
				...
				<!--- End Mandatory Sub Block C1 (Confirmation Parties) --->		
					...
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT=":35B:ISIN #TRIM(ISIN)#" ADDNEWLINE="Yes">
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT="#TRIM(SCRIP_NAME)#" ADDNEWLINE="Yes">
			...
			<cfif OptContractInf EQ "SUMMARY">
				...
				<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT=":70D::PART//#trim(REPLACE(CHANGED_TRADE_NO,'M',''))#" ADDNEWLINE="Yes">
			...
			<cfelse>
				...
				<cfloop query="CONTRACTDETAILQUERY">
					...
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT=":16R:OTHRPRTY" ADDNEWLINE="Yes">										
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT=":95Q::EXCH//ORDER DETAILS" ADDNEWLINE="Yes">										
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT=":70D::PART//#TRIM(REPLACE(TRADE_Number,'M',''))#" ADDNEWLINE="Yes">
					...
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT="#TRIM(TRADEDATE1)# #REPLACE(TIMEFORMAT(TRADE_DATETIME,"HH:MM:SS"),':','',"ALL")#" ADDNEWLINE="Yes">
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT=":20C::PROC//#TRIM(ORDER_NO_FULL)#" ADDNEWLINE="Yes">
					<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT=":16S:OTHRPRTY" ADDNEWLINE="Yes">	
				</cfloop>		
			</cfif>	
			
			<Cfif CurrentCon  neq TotalCon>
 				<CFFILE ACTION="APPEND" FILE="#File_Name#" OUTPUT="-}" ADDNEWLINE="yes">
			<cfelse>
	...
	<CFSET	ClientFileGenerated	=	CopyFile_Unix("#File_Name#","#File_Name#")>
	<SCRIPT>
