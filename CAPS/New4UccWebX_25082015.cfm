...
<CFOUTPUT>	
		...
		<CFIF IsDefined("chk#i#")>
			...
			<CFQUERY NAME="GetClientDetails" datasource="#Client.database#">
				...
				,ISNULL(City,'') P_CITY,ISNULL(State,'') P_STATE,ISNULL(Country,'') P_Country,Pin_Code P_Pin_Code,
				POA_FUNDS_PAYINDATE,POA_SECURITY_PAYINDATE
				FROM CLIENT_DETAILS
				WHERE
					CLIENT_ID = '#client_id#'
			</CFQUERY>			
			
			<cfquery name="GETNEWFLAGDATA" datasource="#CLIENT.DATABASE#">
				SELECT isnull(fileversion,0) NEW_FLAG
				from system_settings
				where
					company_code = 'BSE_CASH'
			</cfquery>
			...
			<CFELSE>
				...
				<CFSET FINALSTRING = "#FINALSTRING##ProvideDetails#|#Income#|#GROSSAID#|#NetWorth#|#NETWORTHD#|Y||">
				...
				<!--- <cfquery name="GETNEWFLAGDATA" datasource="#CLIENT.DATABASE#">
					SELECT 
						CASE WHEN CONVERT(DATETIME,CONVERT(VARCHAR(10),GETDATE(),103),103) >= '2015-02-13' THEN 1 ELSE 0 END AS NEW_FLAG
				</cfquery> --->
				<CFIF GETNEWFLAGDATA.NEW_FLAG EQ 1>
					<CFSET POASECURFLAG = "N">
					<CFQUERY NAME="GetclientDpDetails" datasource="#Client.database#">
						Select 	POA
						FROM IO_DP_MASTER
						WHERE
					...
					<CFSET POASECURFLAG = "#GetclientDpDetails.POA#">
					<CFSET FINALSTRING = "#FINALSTRING#|#EQFLAGDATA#|#DERFLAGDATA#|#SLBMFLAGDATA#|#CURRFLAGDATA#|#RDMFLAGDATA#|#POASECURFLAG##CHR(10)#">
				<CFELSEIF GETNEWFLAGDATA.NEW_FLAG EQ 2>
						
					<CFSET POASECURFLAG = "N">
					<CFSET POAFUNDSFLAG = "N">
					<CFSET POAFUNDSDATE = "">
					<CFSET POASECUDATE = "">
					<CFSET GLOBALPOAFLAG = "N">
					
					<CFIF GetClientDetails.POA_FUNDS_PAYINDATE NEQ "">
						<CFSET POAFUNDSFLAG = "Y">
						<CFSET POAFUNDSDATE = "#DATEFORMAT(GetClientDetails.POA_FUNDS_PAYINDATE,'DD/MM/YYYY')#">					
					</CFIF>
					<CFIF GetClientDetails.POA_SECURITY_PAYINDATE NEQ "">
						<CFSET POASECURFLAG = "Y">
						<CFSET POASECUDATE = "#DATEFORMAT(GetClientDetails.POA_SECURITY_PAYINDATE,'DD/MM/YYYY')#">					
					</CFIF>
					<CFIF POASECURFLAG  EQ "Y" OR POAFUNDSFLAG EQ "Y">
						<CFSET GLOBALPOAFLAG = "Y">
					</CFIF>
					
					<CFSET FINALSTRING = "#FINALSTRING#|#EQFLAGDATA#|#DERFLAGDATA#|#SLBMFLAGDATA#|#CURRFLAGDATA#|#RDMFLAGDATA#|#GLOBALPOAFLAG#">	
					<CFSET FINALSTRING = "#FINALSTRING#|#POAFUNDSFLAG#|#POASECURFLAG#|#POAFUNDSDATE#|#POASECUDATE#|#GetClientDetails.P_Country#|#GetClientDetails.P_STATE#|#GetClientDetails.P_CITY#|#GetClientDetails.P_Pin_Code#||#CHR(10)#">	
				<cfelse>					
			...
			<CFELSE>
				...
				<CFIF GETNEWFLAGDATA.NEW_FLAG EQ 1>
					...
					<CFSET POASECURFLAG = "#GetclientDpDetails.POA#">
					<CFSET FINALSTRING = "#FINALSTRING#|#EQFLAGDATA#|#DERFLAGDATA#|#SLBMFLAGDATA#|#CURRFLAGDATA#|#RDMFLAGDATA#|#POASECURFLAG#">
				<CFELSEIF GETNEWFLAGDATA.NEW_FLAG EQ 2>
					<CFSET POASECURFLAG = "N">
					<CFSET POAFUNDSFLAG = "N">
					<CFSET POAFUNDSDATE = "">
					...
					<CFSET FINALSTRING = "#FINALSTRING#|#EQFLAGDATA#|#DERFLAGDATA#|#SLBMFLAGDATA#|#CURRFLAGDATA#|#RDMFLAGDATA#|#GLOBALPOAFLAG#">	
					<CFSET FINALSTRING = "#FINALSTRING#|#POAFUNDSFLAG#|#POASECURFLAG#|#POAFUNDSDATE#|#POASECUDATE#|#GetClientDetails.P_Country#|#GetClientDetails.P_STATE#|#GetClientDetails.P_CITY#|#GetClientDetails.P_Pin_Code#||">	
				<cfelse>					
		...
		<CFELSE>
			...
			<CFIF  ClientFileGenerated>
				<SCRIPT>
					alert("File Generated On Client Machine #REPLACE(ClientFileName,'\','\\','ALL')#");
				</SCRIPT>
			</CFIF>
			
			<CFIF ClientFileGenerated1>
				<SCRIPT>
					alert("Log File Generated on Client Machine #REPLACE(ClientFileNameLog,'\','\\','ALL')#");
				</SCRIPT>
			</CFIF>
		</CFIF>
