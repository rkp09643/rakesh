...
<CFLOOP QUERY="getClientDetails" > <!---  group="CLIENT_ID" groupcasesensitive="no" --->
	...
	<CFSET ERRORCODE = 0>
	<cfif COMPANY_CODE eq 'NSE_CASH'>
		<CFQUERY NAME="GetclientDpDetails" datasource="#Client.database#">
			Select top 3 DEPOSITORY+'|'+CASE WHEN DEPOSITORY = 'cdsl' then '' else DP_ID end +'|'+CLIENT_DP_CODE DpDetails
			FROM IO_DP_MASTER
			WHERE
	...
	<CFQUERY NAME="GETBANKDETAILS" datasource="#Client.database#">
		...
		order by Default_Ac desc 
			...
			<cfelse>
				...
				<cfoutput>
					<CFSET FINALSTRING = "#FINALSTRING##SEGMENT#|#CLIENTID#|#CLIENT_NAME1#|#CATEGORY1#|#PAN_NO1#|#SEX1#|#FATHER_HUSBAND_NAME#|#MARITAL_STATUS1#|#NATIONALITY1#|#Nationality_Others#|#EMAILID#|">
					<CFSET FINALSTRING = "#FINALSTRING##RADD1#|#RADD2#|#RADD3#|#RCITY#|#RSTATE#|#R_STATE_OTH#|#RCOUNTRY#|#RPINCODE#|#FlgIndSameAdd#|">
					...
					<cfif FlgIndSameAdd eq 'y'>
						<CFSET FINALSTRING = "#FINALSTRING#||||||||#ISDCODE#|#STD_CODE#|#RESI_TEL_NO1#|#MOBILE_NO#|">
					<cfelse>
						<CFSET FINALSTRING = "#FINALSTRING##ADD1#|#ADD2#|#ADD3#|#CITY#|#STATE#|#STATE_OTH#|#COUNTRY#|#PINCODE#|#ISDCODE#|#STD_CODE#|#RESI_TEL_NO1#|#MOBILE_NO#|">
					</cfif>
					...
					<cfelseif GROSSAI eq "Ten To TwentyFive Lakhs">
						<cfset Income = "4">
					<cfelseif GROSSAI eq "TwentyFive Lakhs To Fifty Lakhs">
						<cfset Income = "5">
					<cfelseif GROSSAI eq "Fifty Lakhs To One Crore">
						<cfset Income = "5">
					<cfelse>
						<cfset Income = "6">
					</cfif>
					...
					<CFSET FINALSTRING = "#FINALSTRING##ISDCODE_off#|#STD_CODE_off#|#Off_TEL_NO1#|#Date1#|#UID#|">
					...
					<CFSET FINALSTRING = "#FINALSTRING##CIN#|#Income#|#GROSSAID#|#NETWORTH#|#NETWORTHD#|#PEP1#|#POI#|#OCCUPATION1#|#OCCUPATION_OTH#|#DATEOFFCOMM#|#CUSTPC#">
					...
					<!--- #RelationShip1# --->
					<CFSET FINALSTRING = "#FINALSTRING##Person_verify#|#AGREEMENT_DATE1#|#UCC#|#UpdationFlag1#||#TypeOfFacility1#|||||A||#CLIENTTYPE#">
					...
					<CFIF CATEGORY1 EQ 2 OR CATEGORY1 EQ 3 OR CATEGORY1 EQ 4 OR CATEGORY1 EQ 5>
						...
						<CFIF CATEGORY1 NEQ 3>
							...
							<CFIF Contact_Person3 NEQ "" AND DESIGNATIONPERSON3 NEQ "" AND PanNo_Person3 NEQ "" AND Address_Person3 NEQ "" AND TelNo_Person3 NEQ "" >					
					...
					<CFIF CATEGORY1 EQ 2 OR CATEGORY1 EQ 4 OR CATEGORY1 EQ 5>
						...
						AND (Contact_Person3 EQ "" AND DESIGNATIONPERSON3 EQ "" AND PanNo_Person3 EQ "" AND Address_Person3 EQ "" AND TelNo_Person3 EQ "" )>
							<CFSET ERRORCODE  = 3>
						</CFIF>
					</CFIF>
					...
					<CFIF GETNEWFLAGDATA.NEW_FLAG EQ 1>
						...
						<CFSET FINALSTRING = "#FINALSTRING#|#POAFUNDSFLAG#|#POASECURFLAG#">
					</CFIF>
