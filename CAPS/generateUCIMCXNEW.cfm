...
<CFLOOP QUERY="getClientDetails">
	...
	<CFIF  len(GetClientDetails.PAN_NO) eq 10 AND #GetClientDetails.CATEGORY# NEQ "" >				
				...
				<cfset EMAILID = #gettoken(Trim(GetClientDetails.EMAILID),1,';')# >

				 <cfif EMAILID eq "">
					<CFSET EMAILID = "#LEFT(Trim(GetClientDetails.EMAILID),50)#"> 	
				 </cfif>
				 
				<cfif UpdationFlag eq "Y">
					<CFIF TypeOfFacility EQ "2">
						<CFSET MOBILE_NO1 = "#MOBILE_NO#">
						<CFSET EMAILID1 = "">
						<cfset TypeOfFacility1 = "2">
					<cfelseif TypeOfFacility EQ "1">
						<CFSET MOBILE_NO1 = "">
						<CFSET EMAILID1 = "#EMAILID#">
						<cfset TypeOfFacility1 = "1">
					<cfelseif TypeOfFacility EQ "3">
						<CFSET MOBILE_NO1 = "#MOBILE_NO#">
						<CFSET EMAILID1 = "#EMAILID#">
						<cfset TypeOfFacility1 = "3">
					<cfelse>
						<CFSET MOBILE_NO1 = "">
						<CFSET EMAILID1 = "">
						<cfset TypeOfFacility1 = "">
					</CFIF>
				<cfelse>
		...
		<CFELSE>
			...
			<CFELSEIF #GetClientDetails.CATEGORY# EQ "">  			
				<CFSET FINALSTRINGLOG = "#FINALSTRINGLOG#For #CLIENT_ID# Category is Missing#chr(10)#">				
			</CFIF>			
		</CFIF> 
	</CFLOOP>
