...
<cfif IsDefined("CmdGenerate")>
	...
	<CFQUERY NAME="GetSysSetting" datasource="#Client.database#">
		SELECT	
				...
				CONVERT(CHAR(10),GETDATE(),112)CurrentDateInYearFormat,Broker_CMBP_ID,convert(char(10),convert(datetime,'#TRADE_DATE#',103),112) TradedateinFormat
		FROM
				System_Settings
		WHERE
				Company_Code	=	'#COCD#'
	...
	<cfset TradedateinFormat1 = "#GetSysSetting.TradedateinFormat#">
	...
	<cfoutput query="GetTradeData" group="Client_ID">
			...
			<CFOUTPUT GROUP="Scrip_Symbol">
				...
				<cfoutput>
					...
					<CFIF Brokerage_Type EQ "A">
						<CFSET	Brokerage_Type1	=	"#fileConvertString('S', 1, 'R', StringBlankVal)#">
					<CFELSE>
						<CFSET	Brokerage_Type1	=	"#fileConvertString('D', 1, 'R', StringBlankVal)#">
					</CFIF>
					<CFSET	TradeCount		=	IncrementValue(TradeCount)>
					<CFSET	TH_DATA		=	"#TH_DATA#TH|#Buy_Sale1#|#Order_No#|#Ord_DateTime#|#Trd_No#|#Trd_DateTime#|#Trade_Qty#|#Trade_Rate#|#Brokerage#|#Net_Rate#|#Setl_Amount#||#Brokerage_Type1##CHR(10)#">
				</cfoutput>
				...
				<CFSET Scrip_Symbol1	=	"SH|#fileConvertString(Scrip_Symbol, 20, 'L', StringBlankVal)#-#fileConvertString(SCRIP_NAME, 20, 'L', StringBlankVal)#">
				<CFLOOP QUERY="GetScripQty">
					...
					<CFELSE>
						<CFSET Scrip_Net_Quantity	=	"#fileConvertString(0, 20, 'L', IntegerBlankVal)#">	
					</CFIF>	
		...
		<cfset	BHDATA	=	"BECN#CHR(10)#BH|#fileConvertString( Register_Id, 4, 'L', IntegerBlankVal)#|#fileConvertString( TradedateinFormat1, 5, 'R', IntegerBlankVal)##Trim(GenerationNo)#|#fileConvertString( ClientSrNo, 5, 'R', IntegerBlankVal)#">
		<cfset	FileName			=	"#fileConvertString( TradedateinFormat1, 5, 'R', IntegerBlankVal)##Trim(GenerationNo)#.txt">
