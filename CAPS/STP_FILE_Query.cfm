...
<CFSET Trade_Date = "#txtOrderDate#">
	...
	<CFQUERY NAME="GetSystemDetail" datasource="#Client.database#">
		SELECT	
				...
				IsNull(ClientList_STTNotApplied, '~')ClientList_STTNotApplied,SCRIP_LIST_STT_NOT_APPLIED
		FROM
				System_Settings
		Where
				Company_Code	=	'#COCD#'		
	...
	<CFLOOP QUERY="GetClient">
		...
		<CFLOOP QUERY="ContData">
			...
			<cfif ListFindNoCase(UCase(GetSystemDetail.SCRIP_LIST_STT_NOT_APPLIED),'#ucase(txtScrip)#',',') neq	0>
				<CFSET	APPLY_STT	=	FALSE>
			</cfif>
