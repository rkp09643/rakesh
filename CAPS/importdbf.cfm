...
<CFFORM ACTION="importdbf.cfm" METHOD="POST" ENABLECAB="Yes">
  ...
  >>	File Name for "DP MASTER " is "DPMAST.dbf" (Comtek File Name : ADPMAST.DBF).<BR>
...
<BR><BR>
  ...
  <CFIF IsDefined("cmdImportBrokerage")>
	...
	<CFOUTPUT QUERY="GetBrk1" GROUP="SBBRKSLB">
	...
	<CFIF ISDEFINED("IMPDPMAST")>
		...
		<CFLOOP query="GETCLIENTIDS">
			<cfif LEN(DPACCODE) NEQ 0>
				...
				<cfIF CHECKFORCLIENTMASTER.RECORDCOUNT GT 0 >					
