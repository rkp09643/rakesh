<cfoutput>
	...
	<cfif COCD EQ "BSE_CASH">
		...
		<CFLOOP QUERY="selTrades">
			...
			<CFIF Buy_Sale	EQ	"BUY">
				<CFSET	Rate123	=	NumberFormat( (Price_Premium + (Trade_Brokerage + Delivery_Brokerage)), "999999.99")>
				<CFSET  BRK123 = NumberFormat((Trade_Brokerage + Delivery_Brokerage), "999999.99")>
	...
	<cfif COCD EQ "MCX">
		...
		<CFLOOP QUERY="selTrades">
			...
			<CFSET	NSEData	=	"">				
			<CFSET	NSEData	=	"#fileConvertString('0', 7, 'L', ' ')#,#fileConvertString('', 2, 'R', ' ')#,#fileConvertString(UCASE(EXP_DATE1), 9, 'R', ' ')#,#fileConvertString(POSITION_SYMBOL, 10, 'L', ' ')#,#fileConvertString(INSTRUMENT_TYPE, 6, 'L', ' ')#,#fileConvertString(STRIKE_PRICE, 10, 'R', ' ')#,#fileConvertString(OPTION_TYPE1, 2, 'L', ' ')#,#fileConvertString(LEFT(TRIM(REPLACE(Scrip_SYMBOL,'CF','','ALL')),25), 25, 'L', ' ')#,#fileConvertString('', 2, 'L', ' ')#,#fileConvertString('', 3, 'L', ' ')#,#fileConvertString('', 2, 'L', ' ')#,#fileConvertString(USER_ID, 10, 'L', ' ')#,#fileConvertString('', 2, 'L', ' ')#,#fileConvertString(BSFlag, 1, 'L', ' ')#,#fileConvertString(Rate, 12, 'R', ' ')#,#fileConvertString(NEWQTY, 9, 'L', ' ')#,#fileConvertString('', 1, 'R', ' ')#,#fileConvertString(BROKER_CODE, 12, 'L', ' ')#,#fileConvertString(Client_ID, 10, 'L', ' ')#,#fileConvertString('CLOSE', 5, 'L', ' ')#,#fileConvertString('UNCOVER', 7, 'L', ' ')#,#fileConvertString(' ', 15, 'L', ' ')#,#fileConvertString(Left(TRDDATETIME,11), 20, 'L', ' ')#,#fileConvertString(LEFT(TRDDATETIME,11), 20, 'L', ' ')#,#fileConvertString('', 3, 'L', ' ')#">
	...
	<cfif COCD EQ "NCDEX">
		...
		<CFLOOP QUERY="selTrades">
			...
			<CFSET	NSEData	=	"">				
			<CFSET	NSEData	=	"#fileConvertString('0', 7, 'L', ' ')#,#fileConvertString('', 2, 'R', ' ')#,#fileConvertString(EXP_DATE1, 9, 'R', ' ')#,#fileConvertString(SCRIP_NAME, 10, 'L', ' ')#,#fileConvertString(INSTRUMENT_TYPE, 6, 'L', ' ')#,#fileConvertString(STRIKE_PRICE, 10, 'R', ' ')#,#fileConvertString(OPTION_TYPE1, 2, 'L', ' ')#,#fileConvertString(LEFT(REPLACE(Scrip_SYMBOL,'CF','','ALL'),25), 25, 'L', ' ')#,#fileConvertString('', 2, 'L', ' ')#,#fileConvertString('', 3, 'L', ' ')#,#fileConvertString('', 2, 'L', ' ')#,#fileConvertString(TRIM(USER_ID), 10, 'L', ' ')#,#fileConvertString('', 2, 'L', ' ')#,#fileConvertString(BSFlag, 1, 'L', ' ')#,#fileConvertString(NEWRATE, 12, 'R', ' ')#,#fileConvertString(Quantity, 9, 'L', ' ')#,#fileConvertString('', 1, 'R', ' ')#,#fileConvertString(BROKER_CODE, 12, 'L', ' ')#,#fileConvertString(Client_ID, 10, 'L', ' ')#,#fileConvertString('CLOSE', 5, 'L', ' ')#,#fileConvertString('UNCOVER', 7, 'L', ' ')#,#fileConvertString(' ', 15, 'L', ' ')#,#fileConvertString(LEFT(TRDDATETIME,11), 20, 'L', ' ')#,#fileConvertString(LEFT(TRDDATETIME,11), 20, 'L', ' ')#,#fileConvertString('', 3, 'L', ' ')#">
